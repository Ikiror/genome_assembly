...
#SBATCH --output=/data/users/aikiror/genomeAssembly/report_and_errors/output_15_nucmer_%j.o
#SBATCH --error=/data/users/aikiror/genomeAssembly/report_and_errors/error_15_nucmer_%j.e
#SBATCH --partition=pibu_el8

WORKDIR="/data/users/aikiror/genomeAssembly"
OUTPUTDIR="${WORKDIR}/output_files/week3/15_nucmer"
