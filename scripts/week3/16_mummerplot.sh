...
#SBATCH --output=/data/users/aikiror/genomeAssembly/report_and_errors/output_16_mummerplot_%j.o
#SBATCH --error=/data/users/aikiror/genomeAssembly/report_and_errors/error_16_mummerplot_%j.e
#SBATCH --partition=pibu_el8

WORKDIR="/data/users/aikiror/genomeAssembly"
OUTPUTDIR="${WORKDIR}/output_files/week3/16_mummerplot"
