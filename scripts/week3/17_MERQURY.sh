...
#SBATCH --output=/data/users/aikiror/genomeAssembly/report_and_errors/output_17_MERQURY_%j.o
#SBATCH --error=/data/users/aikiror/genomeAssembly/report_and_errors/error_17_MERQURY_%j.e
...
OUTPUTDIR="${WORKDIR}/output_files/week3/17_MERQURY"
mkdir -p ${OUTPUTDIR}
